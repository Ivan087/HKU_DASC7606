...
class PyramidFeatureNetwork(nn.Module):
    ...
    def forward(self, inputs):
        ...
        P5_x = self.P5_2(P5_x)      #H/4

        P4_x = self.P4_1(C4)
        P4_x = P5_upsampled_x + P4_x
        P4_upsampled_x = self.P4_upsampled(P4_x)
        P4_x = self.P4_2(P4_x)      #H/2

        P3_x = self.P3_1(C3)
        P3_x = P3_x + P4_upsampled_x
        P3_x = self.P3_2(P3_x)      #H/2

        P6_x = self.P6(C5)          #H/16

        P7_x = self.P7_1(P6_x)
        P7_x = self.P7_2(P7_x)      #H/32
